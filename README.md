...
| `meridian_loom` | custom, MCP, A2A | Planned (0/7) — [spec + public experimental scaffold](docs/LOOM_SPEC.md), including 7-surface experimental preflight rehearsal, read-only reference gate checks, and a local sanction preview that can fail closed before native runtime enforcement exists |
