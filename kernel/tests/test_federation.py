...
def _seed_workspace_root(root_dir, *, org_id, user_id, host_id, port, signing_secret,
    ...
    shutil.copytree(kernel_src, kernel_dst, ignore_dangling_symlinks=True, ignore=shutil.ignore_patterns("*.json", "*.jsonl", "*.lock"))
    shutil.copytree(economy_src, economy_dst, ignore_dangling_symlinks=True, ignore=shutil.ignore_patterns("*.json", "*.jsonl", "*.lock"))
