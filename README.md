...
| `meridian_loom` | custom, MCP, A2A | Planned (0/7) — [spec + public experimental scaffold](docs/LOOM_SPEC.md), including 5-hook experimental preflight surfaces but no governed runtime yet |
