...
|-------|------|---------------|------|
| 0 (current) | Spec + public scaffold + 7-surface rehearsal + fail-closed `loom action execute` + runtime-side audit artifacts + parity stream with optional live OpenClaw proof snapshot | 0/7 | — |
