...
def _seed_workspace_root(root_dir, *, org_id, user_id, host_id, port, signing_secret,
    ...
    shutil.copytree(kernel_src, kernel_dst, ignore_dangling_symlinks=True, ignore=shutil.ignore_patterns('*.pyc', '__pycache__', 'capsules'))
    ...
    # Do not copy pre-initialized capsules that might exist if tests are run after quickstart.py
