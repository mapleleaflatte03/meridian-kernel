...
| `meridian_loom` | hosted | Planned (0/7, spec + public experimental scaffold with 7-surface rehearsal, fail-closed `loom action execute`, runtime-side audit artifacts, and a parity stream with optional live OpenClaw proof snapshots — [LOOM_SPEC](docs/LOOM_SPEC.md)) |
